...
async def pulse_uio(dut, bit_index, data_byte=None):
...
@cocotb.test()
async def test_aes128_baseline_wrapper_known_vector(dut):
    dut._log.info("Start AES-128 baseline Tiny Tapeout wrapper test")

    # 100 MHz simulation clock. This is only for simulation.
